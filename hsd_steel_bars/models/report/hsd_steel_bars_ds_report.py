...
class HSDSteelBarsReport(models.AbstractModel):
    _name = 'report.hsd_steel_bars.hsd_steel_bars_report'
    _description = 'HSD Steel Bars Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/hsd_steel_bars/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
...
class HSDSteelBarsDatasheet(models.AbstractModel):
    _name = 'report.hsd_steel_bars.hsd_steel_bars_datasheet'
    _description = 'HSD Steel Bars DataSheet'
