...
# class HtStrandReport(models.AbstractModel):
#     _name = 'report.ht_strand.ht_strand_report'
#     _description = 'Ht Strand Report'
...
class HtStrandReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/ht/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
...
class  HtstrandDataSheet(models.AbstractModel):
    _name = 'report.ht_strand.ht_strand_datasheet'
