...
# class SsRoundReport(models.AbstractModel):
#     _name = 'report.ss_round.ss_round_report'
#     _description = 'TMT BAR'
...
#         report_url = f"{base_url}/download_report/ss_round/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
...
# class SsRoundDataSheet(models.AbstractModel):
#     _name = 'report.ss_round.ss_round_datasheet'
#     _description = 'SS Round DataSheet'
...
class StructuralSteelRoundDataSheet(models.AbstractModel):
    _name = 'report.ss_round.ss_round_datasheet'
    _description = 'Structural Steel Round DataSheet'
...
class StructuralSteelRound(models.AbstractModel):
    _name = 'report.ss_round.ss_round_report'
    _description = 'Steel Round'
