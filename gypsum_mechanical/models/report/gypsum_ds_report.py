...
class GypsumFlyAshDatasheet(models.AbstractModel):
    _name = 'report.gypsum_mechanical.gypsum_datasheet'
    _description = 'Gypsum Mechanical Datasheet'
...
# class GypsumChemicalReport(models.AbstractModel):
#     _name = 'report.gypsum_chemical.gypsum_chemical_report'
#     _description = 'Gypsum Chemical Report'
...
class GypsumMechanicalReport(models.AbstractModel):
    _name = 'report.gypsum_mechanical.gypsum_report'
    _description = 'Gypsum Mechanical Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/gypsum/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
