...
class ChemicalDrinkingWaterChemicalDatasheet(models.AbstractModel):
    _name = 'report.drinking_water_chemi.drinking_water_chemi_datasheet'
    _description = 'Drinking Water Chemical Datasheet'
...
class DrinkingWaterChemicalReport(models.AbstractModel):
    _name = 'report.drinking_water_chemi.drinking_water_chemi_report'
    _description = 'Drinking Water Chemical Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/drinkwater/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
