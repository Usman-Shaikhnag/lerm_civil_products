...
class ChemicalGyspum(models.Model):
    ...
    notes_id = fields.One2many('chemical.gyspum.notes', 'parent_id', string="Notes", default=lambda self: self._default_notes_lines())
...
class ChemicalGyspumNotes(models.Model):
