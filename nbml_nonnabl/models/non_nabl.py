...
class NONNABL(models.Model):
    _name = "nbml.nonnabl"
    _inherit = "lerm.eln"
    _rec_name = "name"

    name = fields.Char("Name",default="NON-NABL")
    ...
    def default_get(self, fields):
        res = super(NONNABL, self).default_get(fields)
    ...
    line_ids = fields.One2many('mechanical.nonnabl.line', 'parent_id', string="Test Lines")
    ...
    def _compute_visible(self):
        for record in self:
            ...
            for sample in record.sample_parameters:
                ...
                if sample.internal_id == '633547hjy-645d-4794-a0fd-3daa01587896':
    ...
    def open_eln_page(self):
        ...
        for result in technician_results:
            ...
            # Water Absorbtion
            if result.parameter.internal_id == '633547hjy-645d-4794-a0fd-3daa01587896':
    ...
    def create(self, vals):
        ...
        record = super(NONNABL, self).create(vals)
    ...
    def get_all_fields(self):
        record = self.env['nbml.nonnabl'].browse(self.ids[0])
        field_values = {}
...
class MechanicalNonnablLine(models.Model):
    _name = "mechanical.nonnabl.line"
    parent_id = fields.Many2one('nbml.nonnabl',string="Parent Id")
    ...
    def create(self, vals):
        ...
        return super(MechanicalNonnablLine, self).create(vals)
...
class NonnablNotes(models.Model):
    _name = "nbml.nonnabl.notes"
