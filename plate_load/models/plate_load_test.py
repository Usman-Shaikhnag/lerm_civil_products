...
# CALCULATION FOR ALLOWABLE BEARING CAPACITY BASED ON RESULT OF PLATE LOAD TEST
    ...
    notes_id = fields.One2many('mechanical.plate.test1.notes', 'parent_id', string="Notes", default=lambda self: self._default_notes_lines())
...
class PlateLoadNotes(models.Model):
    _name = "mechanical.plate.test1.notes"
