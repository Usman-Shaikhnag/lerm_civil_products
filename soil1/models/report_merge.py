...
class ReportMerge(models.AbstractModel):
    ...
    def _render_qweb_pdf(self, report_ref, docids=None, data=None):
        ...
        if report_ref == 'soil1.soil_report1':
            ...
            pdf1, _ = super()._render_qweb_pdf('lerm_civil.soil_report_first_action', docids, data=data)
            pdf2, _ = super()._render_qweb_pdf('lerm_civil.soil_report_rest_action', docids, data=data)
