...
class CementNormalConsistency(models.Model):
    ...
    avg_cement_nabl = fields.Selection([
        ('pass', 'Pass'),
        ('fail', 'Fail'),
    ], string='NABL', compute="_compute_avg_cement_nabl")
    ...
    avg_density_conformity = fields.Selection([
        ('pass', 'Pass'),
        ('fail', 'Fail'),
    ('na', 'NA'),], string='Conformity', default='fail',compute="_compute_avg_density_conformity")
    ...
    avg_fineness_blaine_conformity = fields.Selection([
        ('pass', 'Pass'),
        ('fail', 'Fail'),
    ('na', 'NA'),], string='Conformity', default='fail',compute="_compute_avg_fineness_blaine_conformity")
    ...
    avg_soundness_cement_conformity = fields.Selection([
        ('pass', 'Pass'),
        ('fail', 'Fail'),
    ('na', 'NA'),], string='Conformity', default='fail',compute="_compute_avg_soundness_cement_conformity")
    ...
    consitency_of_cement_conformity = fields.Selection([
        ('pass', 'Pass'),
        ('fail', 'Fail'),
    ('na', 'NA'),], string='Conformity', default='fail',compute="_compute_consitency_of_cement_conformity")
    ...
    final_setting_conformity = fields.Selection([
        ('pass', 'Pass'),
        ('fail', 'Fail'),
    ('na', 'NA'),], string='Conformity', default='fail',compute="_compute_final_setting_conformity")
    ...
    avg_specific_gravity_conformity = fields.Selection([
        ('pass', 'Pass'),
        ('fail', 'Fail'),
    ('na', 'NA'),], string='Conformity', default='fail',compute="_compute_avg_specific_gravity_conformity")
    ...
    avg_3_days_conformity = fields.Selection([
        ('pass', 'Pass'),
        ('fail', 'Fail'),
    ('na', 'NA'),], string='Conformity', default='fail',compute="_compute_avg_3_days_conformity")
    ...
    avg_7_days_conformity = fields.Selection([
        ('pass', 'Pass'),
        ('fail', 'Fail'),
    ('na', 'NA'),], string='Conformity', default='fail',compute="_compute_avg_7_days_conformity")
    ...
    avg_28_days_conformity = fields.Selection([
        ('pass', 'Pass'),
        ('fail', 'Fail'),
    ('na', 'NA'),], string='Conformity', default='fail',compute="_compute_avg_28_days_conformity")
