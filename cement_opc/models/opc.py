...
class CementNormalConsistency(models.Model):
    ...
    notes_id = fields.One2many('opc.notes1', 'parent_id', string="Notes",ondelete='cascade')
    ...
    opc_soundness_table = fields.One2many('opc.soundness.autoclave.line','parent_id',string="Parameter")
...
class SoundnessAutoclaveMethod(models.Model):
    _name = "opc.soundness.autoclave.line"
