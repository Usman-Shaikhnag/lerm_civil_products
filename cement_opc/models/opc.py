...
class CementNormalConsistency(models.Model):
    ...
    avg_cement_conformity = fields.Selection([
        ...
        ('fail', 'Fail'),
        ('na', 'NA'),
    ], string='Conformity',compute="_compute_avg_cement_conformity",store=True)
    ...
    #     ('fail', 'Fail'),
    #     ('na', 'NA'),
    # ], string='Conformity',compute="_compute_avg_soundness_cement_conformity")
    ...
    compressive_lines_7days = fields.One2many('compressive.line.7days','parent_id',string="Compressive")
    ...
    compressive_lines_28days = fields.One2many('compressive.line.28days','parent_id',string="Compressive")
    ...
    avg_expantion = fields.Float("Average Expansion % (mm)",compute="_compute_avg_expansion",store=True,digits=(12,3))
    ...
    def _compute_avg_expantion_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','3555668877t-372f-4775-9bcb-e9dd723547htui')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','3555668877t-372f-4775-9bcb-e9dd723547htui')]).parameter_table
            mu_value = line.mu_value
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
    ...
    def _compute_avg_expantion1_conformity(self):
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','44455yutr1-372f-4775-9bcb-e9dd723001478h')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','44455yutr1-372f-4775-9bcb-e9dd723001478h')]).parameter_table
            mu_value = line.mu_value
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
    ...
    def _compute_visible(self):
        for record in self:
            ...
            for sample in record.sample_parameters:
                ...
                if sample.internal_id == '44455yutr1-372f-4775-9bcb-e9dd723001478h':
    ...
    def open_eln_page(self):
        ...
        for result in technician_results:
            ...
            if result.parameter.internal_id == '3555668877t-372f-4775-9bcb-e9dd723547htui':
            ...
            if result.parameter.internal_id == '44455yutr1-372f-4775-9bcb-e9dd723001478h':
