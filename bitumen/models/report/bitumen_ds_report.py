...
class BitumenReport(models.AbstractModel):
    _name = 'report.bitumen.lerm_bitumen_report'
    _description = 'Bitumen Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/bitumen/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
...
class BitumenDataSheet(models.AbstractModel):
    _name = 'report.bitumen.bitumenn_datasheet'
    _description = 'Bitumen DataSheet'
