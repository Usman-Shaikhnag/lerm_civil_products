...
class ChemicalFlyAshDatasheet(models.AbstractModel):
    _name = 'report.fly_ash_chemical.flyash_chem_datasheet'
...
#     _name = 'report.fly_ash_chemical.flyash_chemical_report'
...
class FlyAshChemicalReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/flyc/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
