...
class ChemicalFlyAsh(models.Model):
    ...
    notes_id = fields.One2many('chemical.flyash.notes', 'parent_id', string="Notes", default=lambda self: self._default_notes_lines())
...
class ChemicalFlyAshNotes(models.Model):
    _name = "chemical.flyash.notes"
