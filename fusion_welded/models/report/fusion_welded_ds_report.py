...
class FusionWeldedDatasheet1(models.AbstractModel):
    _name = 'report.fusion_welded.fusion_welded_datasheet'
    _description = 'Fusion Welded DataSheet'
...
class FusionWeldedReport(models.AbstractModel):
    _name = 'report.fusion_welded.fusion_welded_report'
