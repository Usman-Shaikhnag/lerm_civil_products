...
class MicrosilicaDatasheet(models.AbstractModel):
        _name = 'report.microsilica.microsilica_datasheet'
...
# class MicrosilicaReport(models.AbstractModel):
#     _name = 'report.microsilica.microsilica_report'
#     _description = 'Microsilica Report '
...
#         microsilica_data = self.env[model].search([("id","=",eln.model_id)])
#         print(microsilica_data.control_compressive_strength_7_days)
#         return {
#             'eln': eln,
...
class MicrosilicaReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/microsilica/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
