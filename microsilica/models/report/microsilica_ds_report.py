...
class MicrosilicaDatasheet(models.AbstractModel):
        _name = 'report.microsilica.microsilica_datasheet1'
        _description = 'Microsilica DataSheet 1'
...
class MicrosilicaReport(models.AbstractModel):
    _name = 'report.microsilica.lerm_microsilica_report1'
    _description = 'Microsilica Report 1'
