...
class StainlessSteelReport(models.AbstractModel):
    _name = 'report.stainless_steel.stainless_steel_report'
...
class StainlessSteelDataSheet(models.AbstractModel):
    _name = 'report.stainless_steel.stainless_steel_datasheet'
