...
class ActReport(models.AbstractModel):
    _name = 'report.act_concrete_cube.act_report'
    _description = 'Act Report'
    ...
    def _get_report_values(self, docids, data):
        ...
        act_data = self.env[model].search([("id","=",eln.model_id)])
        return {
            'eln': eln,
            'data': act_data,
            'qrcode': qr_code,
...
class ACTDatasheet(models.AbstractModel):
    _name = 'report.act_concrete_cube.act_datasheet'
    _description = 'ACT DataSheet'
