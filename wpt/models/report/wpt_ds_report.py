...
class WptDatasheet1(models.AbstractModel):
        _name = 'report.wpt.wpt_datasheet'
...
# class WPTReport1(models.AbstractModel):
#     _name = 'report.wpt.wpt_report'
...
class WPTReport1(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/wpt/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
