...
class DenseBituminousMacadamDatasheet(models.AbstractModel):
        _name = 'report.dense_bituminous_macadam.dense_bitum_macadam_datasheet'
        _description = 'Dense Bituminous Macadam Datasheet'
...
class DenseBituminousMacadamReport(models.AbstractModel):
    _name = 'report.dense_bituminous_macadam.dense_bitum_macadam_report'
    _description = 'Dense Bituminous Macadam Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/dense_bituminous_macadam/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
    ...
    #     )
    #     base_url = self.env['ir.config_parameter'].sudo().get_param('web.base.url')
    #     report_url = f"{base_url}/download_report/bitumenc/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
