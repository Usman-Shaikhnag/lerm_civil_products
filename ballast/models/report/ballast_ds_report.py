...
class BallastReport(models.AbstractModel):
    _name = 'report.ballast.lerm_ballast_report'
    _description = 'Ballast Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/ballast/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
        ...
        return {
            ...
            "data": general_data,
            # "notes_list": (
            #     general_data.notes_id
            #     if hasattr(general_data, "notes_id") and general_data.notes_id
            #     else []
            # ),
            "qrcode": qr_code,  
...
class BallastDataSheet(models.AbstractModel):
    _name = 'report.ballast.ballast_datasheet'
    _description = 'Ballast DataSheet'
