...
class SNRNDT(models.Model):
    _name = "snr.ndt"
    _inherit = "lerm.eln"
    _rec_name = "name"

    name = fields.Char("Name",default="SNR NDT")
    ...
    notes_id = fields.One2many('snr.ndt.notes', 'parent_id', string="Notes")
    
    @api.model
    def default_get(self, fields):
        res = super(SNRNDT, self).default_get(fields)
    ...
    line_ids = fields.One2many('ndt.snr.line', 'parent_id', string="Test Lines")
    ...
    def _compute_visible(self):
        for record in self:
            ...
            for sample in record.sample_parameters:
                ...
                if sample.internal_id == '639993325hjy-645d-4794-a0fd-3daa0199852147':
    ...
    def open_eln_page(self):
        ...
        for result in technician_results:
            ...
            # Water Absorbtion
            if result.parameter.internal_id == '639993325hjy-645d-4794-a0fd-3daa0199852147':
    ...
    def create(self, vals):
        ...
        record = super(SNRNDT, self).create(vals)
    ...
    def get_all_fields(self):
        record = self.env['snr.ndt'].browse(self.ids[0])
        field_values = {}
...
class SNRNDTLine(models.Model):
    _name = "ndt.snr.line"
    parent_id = fields.Many2one('snr.ndt',string="Parent Id")
    ...
    def create(self, vals):
        ...
        return super(SNRNDTLine, self).create(vals)
