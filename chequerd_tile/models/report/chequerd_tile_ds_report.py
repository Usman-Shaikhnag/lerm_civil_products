...
class TileChequredDatasheet1(models.AbstractModel):
        _name = 'report.chequerd_tile.tile_chequred_datasheet1'
        _description = 'Tile  Chequered DataSheet 1'
...
class TileChequeredReport1(models.AbstractModel):
    _name = 'report.chequerd_tile.tile_chequered_report1'
    _description = 'Tile Chequered Report 1'
