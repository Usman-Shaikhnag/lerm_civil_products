...
#     report_no1 = fields.Many2many("lerm.srf.sample", string="SMT NO.",domain="['&',('state', '=', '4-in_report'),('invoice_status', '!=', '2-invoiced'),'|',('srf_id.customer', '=', partner_id),('srf_id.billing_customer', '=', partner_id)]")
