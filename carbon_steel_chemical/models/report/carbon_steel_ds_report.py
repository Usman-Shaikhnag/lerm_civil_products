...
class CarbonSteelReport(models.AbstractModel):
    _name = 'report.carbon_steel_chemical.carbon_steel_chemical_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/carbonsteel/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
...
class TMTBarDataSheet(models.AbstractModel):
    _name = 'report.carbon_steel_chemical.carbon_steel_chemical_datasheet'
