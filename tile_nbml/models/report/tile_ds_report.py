...
class TilesNbmlDatasheet1(models.AbstractModel):
        _name = 'report.tile_nbml.tile_nbml_datasheet'
...
class TilesReport(models.AbstractModel):
    _name = 'report.tile_nbml.tile_nbml_report'
    _description = 'Tiles Report'
