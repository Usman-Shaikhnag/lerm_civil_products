...
class Door(models.Model):
    ...
    notes_id = fields.One2many('mechanical.door.notes', 'parent_id', string="Notes", default=lambda self: self._default_notes_lines())
...
class DoorNotes(models.Model):
    _name = "mechanical.door.notes"

    parent_id = fields.Many2one('mechanical.door', string="Parent Id")
