...
class DoorDatasheet(models.AbstractModel):
        _name = 'report.door.door_datasheet'
        _description = 'Door DataSheet '
...
# class DoorReport(models.AbstractModel):
#     _name = 'report.door.door_report'
#     _description = 'Door Report '
...
class DoorReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/door/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
