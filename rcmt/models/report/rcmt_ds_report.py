...
class RcmtDatasheet(models.AbstractModel):
        _name = 'report.rcmt.rcmt_datasheet'
        _description = 'RCMT DataSheet 1'
...
#         rcmt_data = self.env[model].search([("id","=",eln.model_id)])
#         return {
#             'eln': eln,
#             'rcmt': rcmt_data,
#             'qrcode': qr_code,
...
class RCMTReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/rcmt/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
