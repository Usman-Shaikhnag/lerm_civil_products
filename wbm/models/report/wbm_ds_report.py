...
class WbmReport1(models.AbstractModel):
    _name = 'report.wbm.wbm_mec_report'
    ...
    def _get_report_values(self, docids, data):
        ...
        report_url = f"{base_url}/download_report/wbm/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
...
class WbmDatasheet1(models.AbstractModel):
    _name = 'report.wbm.wbm_mech_datasheet'
    _description = 'WBM DataSheet'
