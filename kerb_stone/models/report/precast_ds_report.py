...
class PrecastReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/kerbs/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
...
class PrecastDatasheet(models.AbstractModel):
    _name = 'report.kerb_stone.precast_mech_datasheet'
    _description = 'Precast DataSheet'
