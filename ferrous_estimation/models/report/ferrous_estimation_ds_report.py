...
class FerrousEstimationDatasheet(models.AbstractModel):
    _name = 'report.ferrous_estimation.ferrous_estimation_datasheet'
...
class FerrousEstimationReport(models.AbstractModel):
    _name = 'report.ferrous_estimation.ferrous_estimation_report'
