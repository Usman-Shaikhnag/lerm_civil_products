...
class ConcretecubewaterabsorptionDatasheet(models.AbstractModel):
    _name = 'report.concrete_cube_water_absorption.cube_absorption_datasheet'
...
class ConcretecubewaterabsorptionReport(models.AbstractModel):
    _name = 'report.concrete_cube_water_absorption.cube_absorption_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/waterab/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
