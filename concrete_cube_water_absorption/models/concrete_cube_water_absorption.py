...
class MechanicalConcreteCube(models.Model):
    ...
    notes_id = fields.One2many('concrete.cube.water.absorption.notes', 'parent_id', string="Notes",ondelete='cascade')
    ...
    def open_eln_page(self):
        ...
        for result in technician_results:
            ...
            if result.parameter.internal_id == '2002fc5d-b01c-47c1-a37c-332e37a412a7':
...
class ConcreteCubeDensityNotes(models.Model):
    _name = "concrete.cube.water.absorption.notes"
