...
class ChemicalWasteWaterDatasheet(models.AbstractModel):
    _name = 'report.waste_water_chemical.waste_water_chem_datasheet'
...
class WastWaterChemicalReport(models.AbstractModel):
    _name = 'report.waste_water_chemical.waste_water_chemical_report'
    _description = 'Waste Water Chemical Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/waste/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
