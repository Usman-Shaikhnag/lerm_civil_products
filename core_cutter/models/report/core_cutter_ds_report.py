...
class CoreCutterReport(models.AbstractModel):
    _name = 'report.core_cutter.core_cutter_report'
...
class CoreCutterDataSheet(models.AbstractModel):
    _name = 'report.core_cutter.core_cutter_datasheet'
