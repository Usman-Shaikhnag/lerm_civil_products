...
class CoreCutterMechanical(models.Model):
    _name = "mechanical.core.cutter"
    _inherit = "lerm.eln"
    _rec_name = "name"
    ...
    def prefill_data(self):
        ...
        return {
            ...
            'res_model': 'mechanical.core.cutter.prefill.data',
            'view_mode': 'form',
            'target': 'new',
            'context': {
    ...
    notes_id = fields.One2many('cutter.notes', 'parent_id', string="Notes")
    
    @api.model
    def default_get(self, fields):
        res = super(CoreCutterMechanical, self).default_get(fields)
    ...
    def open_eln_page(self):
        ...
        for result in technician_results:
            ...
            if result.parameter.internal_id == '321t78874gtre-372f-4775-9bcb-996587rte':
    ...
    def create(self, vals):
        # import wdb;wdb.set_trace()
        record = super(CoreCutterMechanical, self).create(vals)
    ...
    def get_all_fields(self):
        record = self.env['mechanical.core.cutter'].browse(self.ids[0])
        field_values = {}
    ...
    def _compute_visible(self):
        for record in self:
            ...
            for sample in record.sample_parameters:
                ...
                if sample.internal_id == '124578874gtre-372f-4775-9bcb-e999987hy':
                    record.density_relation_visible = True

                if sample.internal_id == '321t78874gtre-372f-4775-9bcb-996587rte':
    ...
    density_relation_table = fields.One2many('mech.core.compaction.line','parent_id',string="Density Relation")
    ...
    def _compute_avg_compaction_conformity(self):
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','321t78874gtre-372f-4775-9bcb-996587rte')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','321t78874gtre-372f-4775-9bcb-996587rte')]).parameter_table
...
class CoreCompactionLine(models.Model):
    _name = "mech.core.compaction.line"
    parent_id = fields.Many2one('mechanical.core.cutter',string="Parent Id")
