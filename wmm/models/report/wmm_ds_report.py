...
class WMMReport1(models.AbstractModel):
    _name = 'report.wmm.wmm_mec_report1'
    _description = 'WMM Report 1'
...
class WmmDatasheet1(models.AbstractModel):
    _name = 'report.wmm.wmm_mech_datasheet1'
    _description = 'WMM DataSheet 1'
