...
class WmmPrefillWizard(models.TransientModel):
    _name = 'wmm.prefill.data'
    ...
    def prefill_data(self):
        current_product = self.env['mechanical.wmm'].sudo().browse(self._context['active_id'])
        copy_product = self.env['mechanical.wmm'].sudo().search([
