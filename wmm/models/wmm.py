...
class WmmMechanical(models.Model):
    ...
    specific_water_line_ids = fields.One2many('wmm.specific.gravity.water.absorption.line', 'parent_id', string="Observations")
    ...
    def _compute_avg_specific_gravity_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','48935a6d-40bc-4791-b133-b9818c43709a')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','48935a6d-40bc-4791-b133-b9818c43709a')]).parameter_table
    ...
    crushing_value_child_lines = fields.One2many('wmm.crushing.value.line','parent_id',string="Parameter")
    ...
    def _compute_average_crushing_value_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','d71a0df2-2bbd-4b7e-adec-f9731dee1084')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','d71a0df2-2bbd-4b7e-adec-f9731dee1084')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    abrasion_value_line_ids = fields.One2many('wmm.la.abrasion.line', 'parent_id', string="Observations")
    ...
    def _compute_avg_abrasion_value_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','bghf65241-a4ae-451c-a4cf-36d2c042ed7d')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','bghf65241-a4ae-451c-a4cf-36d2c042ed7d')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    def _compute_loose_avg_confirmity(self):
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','14a012e4-1ea6-420a-806f-53efd96a8329')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','14a012e4-1ea6-420a-806f-53efd96a8329')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    def _compute_rodded_avg_confirmity(self):
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','d7b29644-e44a-4e21-b158-d8ee9c513844')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','d7b29644-e44a-4e21-b158-d8ee9c513844')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    clay_lumps_percent_line_ids = fields.One2many('wmm.deleterious.clay.line', 'parent_id', string="Trials")
    ...
    def _compute_clay_lumps_percent_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','8634c76e-ae55-4011-98c1-70f20c6b5fd1')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','8634c76e-ae55-4011-98c1-70f20c6b5fd1')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    finer75_line_ids = fields.One2many('wmm.material.finer.75.line', 'parent_id', string="Observations")
    ...
    def _compute_avg_finer_percent_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','69ab02a7-1183-4c0c-8f00-76613ebfe25b')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','69ab02a7-1183-4c0c-8f00-76613ebfe25b')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    fine10_line_ids = fields.One2many('wmm.tfv.line', 'parent_id', string="Observations")
    ...
    def _compute_load_10percent_fine_values_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','f32894f3-23b1-4e3f-8cbd-6f98d6130717')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','f32894f3-23b1-4e3f-8cbd-6f98d6130717')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    def _compute_avg_impact_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','3b240165-440e-41ef-ba06-de49f51414e2')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','3b240165-440e-41ef-ba06-de49f51414e2')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    soundness_na2so4_visible = fields.Boolean("SOUNDNESS OF (SODIUM SULPHATE TEST) Visible",compute="_compute_visible")

    soundness_sod_line_ids = fields.One2many(
        'wmm.sodium.sulphate.line',
        'parent_id',
    ...
    def _compute_total_weighted_avg_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','9896a6a5-59e7-4e56-b503-a630e0c6bee3')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','9896a6a5-59e7-4e56-b503-a630e0c6bee3')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    soundness_magtwo_line_ids = fields.One2many(
        'wmm.magnesium.sulphate.two.line',
        'parent_id',
    ...
    def _compute_mag_total_weighted_avg_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','d09e0cb7-b993-481c-bc47-84feb8cc8ba2')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','d09e0cb7-b993-481c-bc47-84feb8cc8ba2')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    elongation_fl_table = fields.One2many('mech.elongation.flakiness.line','parent_id',string="Elongation Flakiness Index",default=lambda self: self.elongation_fl_table_sizes())
    ...
    plastic_limit_table = fields.One2many('wmm.plasticl.limit.line','parent_id',string="Parameter")
    ...
    def _compute_plastic_limit_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','hjgt24512-4295-4d00-977f-205b7a508363')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','hjgt24512-4295-4d00-977f-205b7a508363')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    heavy_table = fields.One2many('wmm.heavy.compaction.line','parent_id',string="Heavy Compaction")
    ...
    def _compute_max_dry_density_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','fe34728f-e1c1-4e90-9209-55c167ddf911')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','fe34728f-e1c1-4e90-9209-55c167ddf911')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    def _compute_omc_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','6c6e4a91-e7b6-4ef7-aae6-c4a47f8d7ac2')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','6c6e4a91-e7b6-4ef7-aae6-c4a47f8d7ac2')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    omc_table = fields.One2many('wmm.omc.compaction.line','parent_id',string="OMC Compaction")
    ...
    def _compute_max_dry_density1_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','a643fc5e-4499-4491-9313-3a3ac95b9bbe')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','a643fc5e-4499-4491-9313-3a3ac95b9bbe')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    def _compute_omc1_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','d6b3387a-b8a4-4896-b91d-358065a6774f')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','d6b3387a-b8a4-4896-b91d-358065a6774f')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    soil_table = fields.One2many('wmm.cbr.line','parent_id',string="CBR",default=lambda self: self._default_soil_table())
    ...
    def _compute_cbr_25_avg_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','d01f238e-a96e-44a3-8922-78c676098af1')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','d01f238e-a96e-44a3-8922-78c676098af1')]).parameter_table
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
                    req_max = material.req_max
    ...
    def _compute_visible(self):
        for record in self:
            ...
            for sample in record.sample_parameters:
                ...
                if sample.internal_id == 'd71a0df2-2bbd-4b7e-adec-f9731dee1084':
                ...
                if sample.internal_id == '14a012e4-1ea6-420a-806f-53efd96a8329':
                    record.loose_bulk_density_visible = True

                if sample.internal_id == 'd7b29644-e44a-4e21-b158-d8ee9c513844':
                ...
                if sample.internal_id == 'f32894f3-23b1-4e3f-8cbd-6f98d6130717':
                    record.fine10_visible = True

                if sample.internal_id == '3b240165-440e-41ef-ba06-de49f51414e2':
                    record.wet_impact_visible = True
              
                
                if sample.internal_id == '9896a6a5-59e7-4e56-b503-a630e0c6bee3':
                    record.soundness_na2so4_visible = True

                if sample.internal_id == 'd09e0cb7-b993-481c-bc47-84feb8cc8ba2':
                ...
                if sample.internal_id == 'fe34728f-e1c1-4e90-9209-55c167ddf911':
                    record.heavy_visible = True

                if sample.internal_id == 'd6b3387a-b8a4-4896-b91d-358065a6774f':
                    record.omc_visible = True
                
                if sample.internal_id == 'd01f238e-a96e-44a3-8922-78c676098af1':
    ...
    def open_eln_page(self):
        ...
        for result in technician_results:
             ...
             # Sieve Analysis
            if result.parameter.internal_id == '32145ghty-6741-4817-95f4-5e53a0676c5f':
                result.calculated = True

            # Bulk Density
            if result.parameter.internal_id == '7d2d5077-590e-4fc3-8097-8794151a6cd8':
                result.calculated = True


             # Loose bulk Density
            if result.parameter.internal_id == '14a012e4-1ea6-420a-806f-53efd96a8329':
            ...
            # Rodded bulk Density
            if result.parameter.internal_id == 'd7b29644-e44a-4e21-b158-d8ee9c513844':
                result.calculated = True
            ...
            # specific gravity 
            if result.parameter.internal_id == '48935a6d-40bc-4791-b133-b9818c43709a':
                result.calculated = True
            ...
            # water absorbtion
            if result.parameter.internal_id == '1478578hgfr-6d14-468e-8488-6d100818e924':
                result.calculated = True
            ...
            # crushing value 
            if result.parameter.internal_id == 'd71a0df2-2bbd-4b7e-adec-f9731dee1084':
                result.calculated = True
            ...
            if result.parameter.internal_id == 'bghf65241-a4ae-451c-a4cf-36d2c042ed7d':
                result.calculated = True
            ...
            # Material finer than 75 micron
            if result.parameter.internal_id == '69ab02a7-1183-4c0c-8f00-76613ebfe25b':
                result.calculated = True
            ...
            # 10 % Fine Value
            if result.parameter.internal_id == 'f32894f3-23b1-4e3f-8cbd-6f98d6130717':
                result.calculated = True
            ...
            # DELETERIOUS MATERIAL (CLAY & LUMPS)
            if result.parameter.internal_id == '8634c76e-ae55-4011-98c1-70f20c6b5fd1':
                result.calculated = True
            ...
            # Wet Impact Value
            if result.parameter.internal_id == '3b240165-440e-41ef-ba06-de49f51414e2':
                result.calculated = True
            ...
            # Soundness - Na2SO4
            if result.parameter.internal_id == '9896a6a5-59e7-4e56-b503-a630e0c6bee3':
                result.calculated = True
            ...
            # Soundness - MgSO4
            if result.parameter.internal_id == 'd09e0cb7-b993-481c-bc47-84feb8cc8ba2':
                result.calculated = True
            ...
            # Elongation
            if result.parameter.internal_id == '312gthdvfe-3e7e-4fff-b912-f7b046f5099c':
                result.calculated = True

            # Flakiness
            if result.parameter.internal_id == 'asd21452-2d4b-47f4-b9ee-7a4a5b176b97':
                result.calculated = True

            # Atterberg's Limit
            if result.parameter.internal_id == '7d03439f-8ccd-4c8d-bf84-b5f95a44d2cb':
                result.calculated = True
            

            # Liquid Limit
            if result.parameter.internal_id == '2145bghty-c438-4d13-bfde-330ee0005734':
                result.calculated = True
            ...
            # Plastic Limit
            if result.parameter.internal_id == 'hjgt24512-4295-4d00-977f-205b7a508363':
                result.calculated = True
            ...
            # Plasticity Index
            if result.parameter.internal_id == '210bgvv-61fd-478f-9bcf-6817965312f1':
                result.calculated = True
            ...
            # Heavy Visible
            if result.parameter.internal_id == 'fe34728f-e1c1-4e90-9209-55c167ddf911':
                result.calculated = True
            ...
            # Heavy Visible
            if result.parameter.internal_id == '6c6e4a91-e7b6-4ef7-aae6-c4a47f8d7ac2':
                result.calculated = True
            ...
            # OMC
            if result.parameter.internal_id == 'a643fc5e-4499-4491-9313-3a3ac95b9bbe':
                result.calculated = True
            ...
            # OMC
            if result.parameter.internal_id == 'd6b3387a-b8a4-4896-b91d-358065a6774f':
                result.calculated = True
            ...
            # CBR
            if result.parameter.internal_id == 'd01f238e-a96e-44a3-8922-78c676098af1':
                result.calculated = True
    ...
    notes_id = fields.One2many('mechanical.wmm.notes', 'parent_id', string="Notes", default=lambda self: self._default_notes_lines())
...
class WmmSpecificGravityWaterAbsorptionLine(models.Model):
    _name = "wmm.specific.gravity.water.absorption.line"
    ...
    def create(self, vals):
        ...
        return super(WmmSpecificGravityWaterAbsorptionLine, self).create(vals)
...
class WmmCrushingValueLine(models.Model):
    _name = "wmm.crushing.value.line"
    parent_id = fields.Many2one('mechanical.wmm', string="Parent Id")
    ...
    def create(self, vals):
        ...
        return super(WmmCrushingValueLine, self).create(vals)
...
class WmmImpactValueLine(models.Model):
    ...
    def create(self, vals):
        ...
        return super(WmmImpactValueLine, self).create(vals)
...
class WmmLooseBulkDensityLine(models.Model):
    _name = "wmm.loose.bulk.density.line"
    parent_id = fields.Many2one('mechanical.wmm', string="Parent Id")
    ...
    def create(self, vals):
        ...
        return super(WmmLooseBulkDensityLine, self).create(vals)
...
class WmmRoddedBulkDensityLine(models.Model):
    _name = "wmm.rodded.bulk.density.line"
    parent_id = fields.Many2one('mechanical.wmm', string="Parent Id")
    ...
    def create(self, vals):
        ...
        return super(WmmRoddedBulkDensityLine, self).create(vals)
...
class WmmDeleteriousClayLine(models.Model):
    _name = "wmm.deleterious.clay.line"
    parent_id = fields.Many2one('mechanical.wmm', string="Parent Id")
    ...
    def create(self, vals):
        ...
        return super(WmmDeleteriousClayLine, self).create(vals)
...
class WmmMaterialFiner75Line(models.Model):
    ...
    def create(self, vals):
        ...
        return super(WmmMaterialFiner75Line, self).create(vals)
...
class WmmTFVLine(models.Model):
    ...
    def create(self, vals):
        ...
        return super(WmmTFVLine, self).create(vals)
...
class WmmWetImpactValueLine(models.Model):
    _name = "wmm.wet.impact.value.line"
    parent_id = fields.Many2one('mechanical.wmm', string="Parent Id")
    ...
    def create(self, vals):
        ...
        return super(WmmWetImpactValueLine, self).create(vals)
...
class WmmSodiumSulphateLine(models.Model):
    _name = "wmm.sodium.sulphate.line"
    parent_id = fields.Many2one('mechanical.wmm', string="Parent Id")
...
class WmmSodiumSulphateTwoLine(models.Model):
    _name = "wmm.sodium.sulphate.two.line"
    parent_id = fields.Many2one('mechanical.wmm', string="Parent Id")
...
class WmmMagnesiumSulphateLine(models.Model):
    _name = "wmm.magnesium.sulphate.line"
    parent_id = fields.Many2one('mechanical.wmm', string="Parent Id")
...
class WmmMagnesiumSulphateTwoLine(models.Model):
    _name = "wmm.magnesium.sulphate.two.line"
    parent_id = fields.Many2one('mechanical.wmm', string="Parent Id")
...
class WMMLIQUIDLIMITLINE(models.Model):
    ...
    def create(self, vals):
        ...
        return super(WMMLIQUIDLIMITLINE, self).create(vals)
...
class WMMPLASTICLIMITLINE(models.Model):
    ...
    def create(self, vals):
        ...
        return super(WMMPLASTICLIMITLINE, self).create(vals)
...
class WMMHEAVYCOMPACTIONLINE(models.Model):
    _name = "wmm.heavy.compaction.line"
    parent_id = fields.Many2one('mechanical.wmm', string="Parent Id")
    ...
    def create(self, vals):
        ...
        return super(WMMHEAVYCOMPACTIONLINE, self).create(vals)
...
class WmmCBRLine(models.Model):
    ...
    def create(self, vals):
        ...
        return super(WmmCBRLine, self).create(vals)
...
class WmmMechanicalNotes(models.Model):
    _name = "mechanical.wmm.notes"
