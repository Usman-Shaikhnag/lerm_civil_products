...
class StainlessSteel(models.Model):
    ...
    notes_id = fields.One2many('mechanical.stainless.steel.tmt.bar.notes', 'parent_id', string="Notes", default=lambda self: self._default_notes_lines())
...
class StainlessSteelNotes(models.Model):
    _name = "mechanical.stainless.steel.tmt.bar.notes"
