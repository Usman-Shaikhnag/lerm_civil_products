...
class ThreadedSteel(models.AbstractModel):
    _name = 'report.threaded_steel.threaded_steel_mech_report'
    _description = 'Threaded Steel Report'
    ...
    def _get_report_values(self, docids, data):
        ...
        threaded_data = self.env[model].sudo().search([("id","=",eln.model_id)])
        # print(threaded_data.normal_consistency)
        return {
            'eln': eln,
            'data': threaded_data,
            'qrcode': qr_code
...
class ThreadedSteelDatasheet(models.AbstractModel):
        _name = 'report.threaded_steel.threaded_steel_mech_datasheet'
        _description = 'Threaded Steel Mech DataSheet'
