...
class TempratureMonitoringDatasheet(models.AbstractModel):
        _name = 'report.temprature_monitoring.temprature_monitoring_datasheet'
        _description = 'Temprature Monitoring DataSheet'
...
class TempratureMonitoringReport(models.AbstractModel):
        _name = 'report.temprature_monitoring.temprature_monitoring_report'
        _description = 'Temprature Monitoring Report'
