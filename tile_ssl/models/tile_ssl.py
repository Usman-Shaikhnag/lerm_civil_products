...
class Tile(models.Model):
    ...
    parameter_id = fields.Many2one('eln.parameters.result',string="Parameter")
    child_lines = fields.One2many('mechanical.dimension.tile.ssl.line','parent_id',string="Parameter")
    ...
    parameter_id = fields.Many2one('eln.parameters.result',string="Parameter")
    child_lines_straightness = fields.One2many('mechanical.straightness.tile.ssl.line','parent_id',string="Parameter")
    ...
    parameter_id = fields.Many2one('eln.parameters.result',string="Parameter")
    child_lines_rectangularity = fields.One2many('mechanical.rectangularity.tile.ssl.line','parent_id',string="Parameter")
    ...
    parameter_id = fields.Many2one('eln.parameters.result',string="Parameter")
    child_lines_centre_curvature = fields.One2many('mechanical.centre.curvature.tile.ssl.line','parent_id',string="Parameter")
    ...
    parameter_id = fields.Many2one('eln.parameters.result',string="Parameter")
    child_lines_edge_curvature = fields.One2many('mechanical.edge.curvature.tile.ssl.line','parent_id',string="Parameter")
    ...
    parameter_id = fields.Many2one('eln.parameters.result',string="Parameter")
    child_lines_warpage = fields.One2many('mechanical.warpage.tile.ssl.line','parent_id',string="Parameter")
    ...
    parameter_id = fields.Many2one('eln.parameters.result',string="Parameter")
    child_lines_water_bulk = fields.One2many('mechanical.water.bulk.tile.ssl.line','parent_id',string="Parameter")
    ...
    parameter_id = fields.Many2one('eln.parameters.result',string="Parameter")
    child_lines_bulk = fields.One2many('mechanical.bulk.tile.ssl.line','parent_id',string="Parameter")
    ...
    parameter_id = fields.Many2one('eln.parameters.result',string="Parameter")
    child_lines_modulus = fields.One2many('mechanical.modulus.tile.ssl.line','parent_id',string="Parameter")
...
#  Scratch hardness According to Moh's Scale
   ...
   ### Compute Visible
    ...
    def get_all_fields(self):
        record = self.env['mechanical.tile.ssl'].browse(self.ids[0])
        field_values = {}
...
class DimensionTile(models.Model):
    _name = "mechanical.dimension.tile.ssl.line"
    parent_id = fields.Many2one('mechanical.tile.ssl',string="Parent Id")
...
class StraightnessTile(models.Model):
    _name = "mechanical.straightness.tile.ssl.line"
    parent_id = fields.Many2one('mechanical.tile.ssl',string="Parent Id")
...
class RectangularityTile(models.Model):
    _name = "mechanical.rectangularity.tile.ssl.line"
    parent_id = fields.Many2one('mechanical.tile.ssl',string="Parent Id")
...
class CentreCurvatureTile(models.Model):
    _name = "mechanical.centre.curvature.tile.ssl.line"
    parent_id = fields.Many2one('mechanical.tile.ssl',string="Parent Id")
...
class EdgeCurvatureTile(models.Model):
    _name = "mechanical.edge.curvature.tile.ssl.line"
    parent_id = fields.Many2one('mechanical.tile.ssl',string="Parent Id")
...
class WarpageTile(models.Model):
    _name = "mechanical.warpage.tile.ssl.line"
    parent_id = fields.Many2one('mechanical.tile.ssl',string="Parent Id")
...
class WaterAndBulkTile(models.Model):
    _name = "mechanical.water.bulk.tile.ssl.line"
    parent_id = fields.Many2one('mechanical.tile.ssl',string="Parent Id")
...
class BulkTile(models.Model):
    _name = "mechanical.bulk.tile.ssl.line"
    parent_id = fields.Many2one('mechanical.tile.ssl',string="Parent Id")
...
class ModulusTile(models.Model):
    _name = "mechanical.modulus.tile.ssl.line"
    parent_id = fields.Many2one('mechanical.tile.ssl',string="Parent Id")
