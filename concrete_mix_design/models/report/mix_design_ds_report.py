...
class DesignMixDatasheet(models.AbstractModel):
    _name = 'report.concrete_mix_design.design_mix_datasheet'
    _description = 'Design Mix DataSheet'
...
class DesignMixReport(models.AbstractModel):
    _name = 'report.concrete_mix_design.design_mix_report'
    _description = 'Design Mix Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/concretemix/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
