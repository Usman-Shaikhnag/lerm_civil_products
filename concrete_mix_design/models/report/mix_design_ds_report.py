...
class DesignMixDatasheet(models.AbstractModel):
    _name = 'report.concrete_mix_design.design_mix_datasheet1'
    _description = 'Design Mix DataSheet 1'
...
class DesignMixReport(models.AbstractModel):
    _name = 'report.concrete_mix_design.design_mix_report1'
    _description = 'Design Mix Report 1'
