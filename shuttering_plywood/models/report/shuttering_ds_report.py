...
class ShutteringPlywoodDatasheet1(models.AbstractModel):
        _name = 'report.shuttering_plywood.shuttering_plywood_datasheet'
        _description = 'Shuttering Plywood DataSheet '
...
# class ShutteringPlywoodReport(models.AbstractModel):
#     _name = 'report.shuttering_plywood.shuttering_plywood_report'
#     _description = 'Shuttering Plywood Report '
...
class ShutteringPlywoodReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/shuttering/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
