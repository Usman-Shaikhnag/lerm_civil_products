...
class ConcreteCoreDatasheet(models.AbstractModel):
        _name = 'report.concrete_core1.concrete_core1_datasheet'
...
class ConcreteCore(models.AbstractModel):
    _name = 'report.concrete_core1.concrete_core1_report'
    _description = 'Concrete Core'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/core/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
