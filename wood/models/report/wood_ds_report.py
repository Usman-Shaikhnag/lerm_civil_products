...
class WoodDatasheet(models.AbstractModel):
    _name = 'report.wood.wood_datasheet_ssl'
    _description = 'Wood DataSheet SSL'
...
# class WoodReport(models.AbstractModel):
#     _name = 'report.wood.wood_report_ssl'
#     _description = 'Wood Report SSL'
...
class WoodReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/wood/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
