...
class WOOD(models.Model):
    ...
    notes_id = fields.One2many('mechanical.wood.notes', 'parent_id', string="Notes", default=lambda self: self._default_notes_lines())
...
class MechanicalSpecificLine(models.Model):
    ...
    def _reorder_serial_numbers(self):
        ...
        for index, record in enumerate(records):
            record.sr_no = index + 1
class WOODNotes(models.Model):
    _name = "mechanical.wood.notes"
