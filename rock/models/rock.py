...
class MechanicalRock(models.Model):
    ...
    point_load_constant_2 = fields.Float(string="Point Load  Constant")
    # 
...
class MechanicalRockLine(models.Model):
    ...
    #                 / (
    #                     math.sqrt(50)
    #                     * (rec.avg_dia ** rec.parent_id.point_load_constant)
    #                 )
    #             )
    #         else:
    #             rec.point_load_strength = 0.0
    ...
    # @api.depends('point_load', 'avg_dia', 'avg_height', 'parent_id.point_load_constant_2')
    # def _compute_point_load_index(self):
    #     for rec in self:
    #         if (
    #             rec.point_load 
    ...
    #             and rec.parent_id.point_load_constant_2 
    #             and rec.parent_id.point_load_constant_2 > 0
    #         ):
    #             rec.point_load_index = (
    #                 (1000 * rec.point_load)
    #                 / (
    #                     math.sqrt(50)
    #                     * ((rec.avg_dia * rec.avg_height) ** rec.parent_id.point_load_constant_2)
    #                 )
    #             )
    #         else:
    #             rec.point_load_index = 0.0
