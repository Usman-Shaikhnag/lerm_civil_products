...
class AluminumAlloysDatasheet1(models.AbstractModel):
    _name = 'report.aluminum_alloys.aluminum_alloys_datasheet'
    _description = 'Aluminum Alloys DataSheet'
...
class AluminumAlloysReport(models.AbstractModel):
    _name = 'report.aluminum_alloys.aluminum_alloys_report'
