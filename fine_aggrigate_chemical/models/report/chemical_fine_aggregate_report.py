...
class ChemicalFineAggregateDatasheet(models.AbstractModel):
    _name = 'report.fine_aggrigate_chemical.chemical_fine_aggregate'
...
# class FineAggregateChemicalReport(models.AbstractModel):
#     _name = 'report.fine_aggrigate_chemical.fine_aggregate_chemical_report'
#     _description = 'Fine Aggregate Chemical Report'
...
#         fine_aggregate_data = self.env[model].sudo().search([("id","=",eln.model_id)])
#         return {
#             'eln': eln,
...
class FineAggregateChemicalReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/finec/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
