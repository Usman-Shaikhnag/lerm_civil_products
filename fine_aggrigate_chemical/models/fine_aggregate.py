...
class ChemicalFineAggregate(models.Model):
    ...
    name = fields.Char("Name",default="Fine Aggregate")
    ...
    notes_id = fields.One2many('chemical.fine.aggregate.notes', 'parent_id', string="Notes", default=lambda self: self._default_notes_lines())
...
class ChemicalFineAggregateNotes(models.Model):
