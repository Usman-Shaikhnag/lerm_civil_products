...
class FerrousPartialDatasheet(models.AbstractModel):
    _name = 'report.ferrous_complete_partial.ferrous_partial_datasheet'
    _description = 'Ferrous Estimation Datasheet'
...
class FerrousPartialReport(models.AbstractModel):
    _name = 'report.ferrous_complete_partial.ferrous_partial_report'
    _description = 'Ferrous Estimation Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/estimation/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
