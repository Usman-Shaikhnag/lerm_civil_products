...
class ConcreteBeamDatasheet(models.AbstractModel):
    _name = 'report.concrete_beam.lerm_cocncrete_beam_datasheet'
...
class ConcreteBeamReport(models.AbstractModel):
    _name = 'report.concrete_beam.lerm_cocncrete_beam_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/beam/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
