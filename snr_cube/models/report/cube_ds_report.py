...
class SNRCubeCompresiveDatasheet1(models.AbstractModel):
    _name = 'report.snr_cube.snr_cube_datasheet'
...
class SNRCubeCompresiveReport(models.AbstractModel):
    _name = 'report.snr_cube.snr_cube_report'
