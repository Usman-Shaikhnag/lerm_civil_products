...
class SandReplacementReport(models.AbstractModel):
    _name = 'report.sand_replacement.sand_replacement_report'
...
class SandreplacementDataSheet(models.AbstractModel):
    _name = 'report.sand_replacement.sand_replacement_datasheet'
