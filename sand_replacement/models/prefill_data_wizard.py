...
class SandReplacmentPrefillWizard(models.TransientModel):
    _name = 'mechanical.sand.replacement.prefill.data'
    ...
    def prefill_data(self):
        current_product = self.env['mechanical.sand.replacement'].sudo().browse(self._context['active_id'])
        copy_product = self.env['mechanical.sand.replacement'].sudo().search([
