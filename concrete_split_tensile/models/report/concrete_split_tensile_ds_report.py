...
class ConcreteSplitTensileDatasheet(models.AbstractModel):
    _name = 'report.concrete_split_tensile.concrete_splite_tensile_datasheet'
    _description = 'Concrete Split Tensile Strength Datasheet'
...
class ConcreteSplitTensileReport(models.AbstractModel):
    _name = 'report.concrete_split_tensile.concrete_splite_tensile_report'
    _description = 'Concrete Split Tensile Strength Report'
