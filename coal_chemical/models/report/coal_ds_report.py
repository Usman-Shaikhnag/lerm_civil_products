...
class ChemicalCoalChemicalDatasheet(models.AbstractModel):
    _name = 'report.coal_chemical.coal_chemical_datasheet'
    _description = 'Coal Chemical Datasheet'
...
class CoalChemicalReport(models.AbstractModel):
    _name = 'report.coal_chemical.coal_chemical_report'
    _description = 'Coal Chemical Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/coal/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
