...
class ConcreteCubeDensityDatasheet(models.AbstractModel):
        _name = 'report.concrete_core_density.concrete_core_density_datasheet'
...
class ConcreteCubeDensityReport(models.AbstractModel):
    _name = 'report.concrete_core_density.concrete_core_density_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/coredensity/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
