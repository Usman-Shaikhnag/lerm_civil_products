...
class PTGroutDatasheet1(models.AbstractModel):
    _name = 'report.pt_grout.pt_grout_datasheet'
...
#     _name = 'report.pt_grout.lerm_ptgrout_report'
#     _description = 'Pt Grout Report '
...
class PtGroutReport1(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/ptgrout/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
