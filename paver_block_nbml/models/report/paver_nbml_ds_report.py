...
#     _name = 'report.fly_ash_chemical1.fly_ash_chem_datasheet'
...
class PaverNbmlReport(models.AbstractModel):
    _name = 'report.paver_block_nbml.paver_block_nbml_report'
    _description = 'Paver BlockReport'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/flyashh/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
