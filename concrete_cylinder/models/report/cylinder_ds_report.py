...
class ConcreteCylinderCompresiveDatasheet1(models.AbstractModel):
    _name = 'report.concrete_cylinder.concrete_cylinder_datasheet'
...
class ConcreteCylinderCompresiveReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/cylinder/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
