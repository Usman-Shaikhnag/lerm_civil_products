...
class ChemicalCrushedSandDatasheet(models.AbstractModel):
    _name = 'report.crushed_sand_chemical.crushed_sand_datasheet'
    _description = 'Crushed Sand Chemical Datasheet'
...
# class CrushedSandChemicalReport(models.AbstractModel):
#     _name = 'report.crushed_sand_chemical.chemical_crushed_sand_report'
#     _description = 'Crushed Sand Chemical Report'
...
#         crushed_sand_data = self.env[model].search([("id","=",eln.model_id)])
#         return {
#             'eln': eln,
#             'data': crushed_sand_data,
#             'qrcode': qr_code,
...
class CrushedSandChemicalReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/crushedsand/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
