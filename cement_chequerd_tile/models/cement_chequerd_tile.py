...
class ChequeredCementTile(models.Model):
    ...
    def prefill_data(self):
        ...
        return {
            ...
            'res_model': 'mechanical.cement.chequered.tile.prefill.data',
            'view_mode': 'form',
            'target': 'new',
            'context': {
    ...
    notes_id = fields.One2many('mechanical.cement.chequered.tile.notes', 'parent_id', string="Notes")
    ...
    # name = fields.Char("Name",default="DIMENSION")
    parameter_id = fields.Many2one('eln.parameters.result',string="Parameter")
    chequered_cement_water_absorption_lines = fields.One2many('mechanical.cement.chequered.water.absorption.line','parent_id',string="Parameter")
    ...
    # name = fields.Char("Name",default="DIMENSION")
    parameter_id = fields.Many2one('eln.parameters.result',string="Parameter")
    chequeredwet_cement_transver_lines = fields.One2many('mechanical.cement.chequered.wet.transverse.line','parent_id',string="Parameter")
...
class ChequeredCementWaterAbsorptionLine(models.Model):
    _name = "mechanical.cement.chequered.water.absorption.line"
    parent_id = fields.Many2one('mechanical.cement.chequered.tile',string="Parent Id")
...
class ChequeredCementWetTransverLine(models.Model):
    _name = "mechanical.cement.chequered.wet.transverse.line"
    parent_id = fields.Many2one('mechanical.cement.chequered.tile',string="Parent Id")
