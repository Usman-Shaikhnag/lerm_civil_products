...
class TileChequredCementDatasheet1(models.AbstractModel):
        _name = 'report.cement_chequerd_tile.cement_tile_chequred_datasheet'
        _description = 'Tile Cement Chequered DataSheet '
...
class TileCementChequeredReport1(models.AbstractModel):
    _name = 'report.cement_chequerd_tile.cement_tile_chequered_report'
    _description = 'Tile Cement Chequered Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/chequerdtile/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
