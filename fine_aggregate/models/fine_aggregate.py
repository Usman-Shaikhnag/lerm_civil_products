...
# Deleterious Material (Coal & Lignite)
  ...
  #  Determination  clay and lump
   ...
   store=True
    ...
    specific_gravity_conformity = fields.Selection([
            ('pass', 'Pass'),
            ('fail', 'Fail'),
    ('na', 'NA'),], string="Conformity", compute="_compute_specific_gravity_conformity", store=True)
    ...
    loose_bulk_density_conformity = fields.Selection([
            ('pass', 'Pass'),
            ('fail', 'Fail'),
    ('na', 'NA'),], string="Conformity", compute="_compute_loose_bulk_density_conformity", store=True)
    ...
    avg_bulking_of_sand1_conformity = fields.Selection([
            ('pass', 'Pass'),
            ('fail', 'Fail'),
    ('na', 'NA'),], string="Conformity", compute="_compute_avg_bulking_of_sand1_conformity", store=True)
 ...
 #   7  % Voids - Loose density
    ...
    avg_void_loose_density_conformity = fields.Selection([
            ('pass', 'Pass'),
            ('fail', 'Fail'),
    ('na', 'NA'),], string="Loose Bulk Conformity", compute="_compute_avg_void_loose_density_conformity", store=True)
    ...
    avg_void_compacted_density_conformity = fields.Selection([
            ('pass', 'Pass'),
            ('fail', 'Fail'),
    ('na', 'NA'),], string="Compacted Bulk Conformity", compute="_compute_avg_void_compacted_density_conformity", store=True)
