...
class FineAggregateDatasheet(models.AbstractModel):
    _name = 'report.fine_aggregate.fine_aggregate_datasheet'
...
class FineAggregateReport1(models.AbstractModel):
    _name = 'report.fine_aggregate.fine_aggregate_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/fine/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
