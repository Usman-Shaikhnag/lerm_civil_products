        ...
        this.env.services.dialog.add(
            ...
            props,
            {
                onClose: () => {
                    this._technicianBlockDialogOpen = false;
                    if (blocking) {
                        // The overdue block cannot be bypassed by closing: the
                        // poll re-runs shortly and re-opens while it persists
                        // (unless the technician completed the work meanwhile).
                        this._scheduleTechnicianBlockCheck(RETRY_MS);
                        return;
                    }
