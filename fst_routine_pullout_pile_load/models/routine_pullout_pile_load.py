...
class RoutinePulloutPileLoadTestParent(models.Model):
    ...
    def print_report(self):
        self.ensure_one()
        report = self.env.ref('fst_routine_pullout_pile_load.routine_pullout_pile_load_report_py3o')
...
class RoutinePulloutPileLoadReportContent(models.Model):
    _name = "routine.pullout.pile.load.report.content"
