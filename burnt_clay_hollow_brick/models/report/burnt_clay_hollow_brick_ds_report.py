...
class BurntClayHollowBrickDatasheet(models.AbstractModel):
        _name = 'report.burnt_clay_hollow_brick.bchb_datasheet'
        _description = 'Burnt Clay Hollow Brick Datasheet'
...
class BurntClayHollowBrickReport(models.AbstractModel):
    _name = 'report.burnt_clay_hollow_brick.bchb_report'
    _description = 'Burnt Clay Hollow Brick Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/burnt_clay_hollow_brick/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
