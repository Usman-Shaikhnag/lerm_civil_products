...
class FreshCementConcreteReport(models.AbstractModel):
    _name = 'report.fresh_cement_concrete.fresh_cement_concrete_report'
    _description = 'Fresh Cement Concrete Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/fresh_cement_concrete/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
...
class FreshCementConcreteDatasheet(models.AbstractModel):
    _name = 'report.fresh_cement_concrete.fresh_cement_concrete_datasheet'
    _description = 'Fresh Cement Concrete DataSheet'
