...
class RcptConcreteCube(models.Model):
    ...
    notes_id = fields.One2many('mechanical.rcpt.notes', 'parent_id', string="Notes", default=lambda self: self._default_notes_lines())
...
class RcptConcreteCubeNotes(models.Model):
    _name = "mechanical.rcpt.notes"
