...
class ChemicalWasteWaterDatasheet(models.AbstractModel):
    _name = 'report.steel_chemical.steel_chemical_datasheet'
...
class WastWaterChemicalReport(models.AbstractModel):
    _name = 'report.steel_chemical.steel_chemical_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/steel/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
