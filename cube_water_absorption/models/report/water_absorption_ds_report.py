...
class CubewaterabsorptionDatasheet(models.AbstractModel):
    _name = 'report.cube_water_absorption.cube_water_absorption_datasheet'
    _description = 'Cube Water Absorption Datasheet'
...
class ConcretecubewaterabsorptionReport(models.AbstractModel):
    _name = 'report.cube_water_absorption.cube_water_absorption_report'
    _description = 'Cube Water Absorption Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/cubewaterab/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
