...
class MechanicalConcreteCubeDensity(models.Model):
    ...
    notes_id = fields.One2many('mechanical.concrete.cube.density.notes', 'parent_id', string="Notes",ondelete='cascade')
    
    @api.model
    def default_get(self, fields):
        res = super(MechanicalConcreteCubeDensity, self).default_get(fields)
    ...
    def open_eln_page(self):
        ...
        for result in technician_results:
            ...
            if result.parameter.internal_id == '235487yt5-7a9c-4616-bad5-88eb1b29087y':
...
class ConcreteCubeDensityNotes(models.Model):
    _name = "mechanical.concrete.cube.density.notes"
