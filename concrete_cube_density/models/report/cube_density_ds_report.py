...
class ConcreteCubeDensityDatasheet(models.AbstractModel):
        _name = 'report.concrete_cube_density.concrete_cube_density_datasheet'
...
class ConcreteCubeDensityReport(models.AbstractModel):
    _name = 'report.concrete_cube_density.concrete_cube_density_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/cubedensity/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
