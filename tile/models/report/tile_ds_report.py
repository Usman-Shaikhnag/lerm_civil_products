...
class TileDatasheet(models.AbstractModel):
        _name = 'report.tile.tile_datasheet'
        _description = 'Tile DataSheet '
...
# class TileReport(models.AbstractModel):
#     _name = 'report.tile.tile_report1'
#     _description = 'Tile Report 1'
...
# class TileReport(models.AbstractModel):
#     _name = 'report.tile.tile_report'
#     _description = 'Tile Report '
...
class TileReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/tile/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
