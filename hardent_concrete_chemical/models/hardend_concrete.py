...
class ChemicalHasdenedConcrete(models.Model):
   ...
   # cement Aggregate ratio 
    ...
    notes_id = fields.One2many('chemical.hardened.concrete.notes', 'parent_id', string="Notes", default=lambda self: self._default_notes_lines())
...
class ChemicalHasdenedConcreteNotes(models.Model):
    _name = "chemical.hardened.concrete.notes"
