...
class ChemicalHasdenedConcreteDatasheet(models.AbstractModel):
    _name = 'report.hardent_concrete_chemical.chemical_hardend_concrete'
    _description = 'Hardend Concrete Chemical Datasheet'
...
# class ChemicalHasdenedConcreteReport(models.AbstractModel):
#     _name = 'report.hardent_concrete_chemical.chemical_hardend_report'
#     _description = 'Hardend Concrete Chemical Report'
...
#         fine_aggregate_data = self.env[model].search([("id","=",eln.model_id)])
#         return {
#             'eln': eln,
#             'data': fine_aggregate_data,
#             'qrcode': qr_code,
...
class ChemicalHasdenedConcreteReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/hardent/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
