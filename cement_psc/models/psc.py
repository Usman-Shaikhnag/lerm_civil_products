...
class CementPsc(models.Model):
    _name = "mechanical.cement.psc.ssl"
    _inherit = "lerm.eln"
    _rec_name = "name"
    ...
    soundness_table = fields.One2many('cement.psc.soundness.ssl.line','parent_id',string="Soundness")
    ...
    dry_sieving_table = fields.One2many('cement.psc.dry.sieving.ssl.line','parent_id',string="Dry Sieving")
    ...
    casting_3_days_tables = fields.One2many('cement.psc.casting.3days.ssl.line','parent_id',string="3 Days")
    ...
    casting_7_days_tables = fields.One2many('cement.psc.casting.7days.ssl.line','parent_id',string="7 Days")
    ...
    casting_28_days_tables = fields.One2many('cement.psc.casting.28days.ssl.line','parent_id',string="28 Days")
    ...
    def get_all_fields(self):
        # import wdb;wdb.set_trace()
        record = self.env['mechanical.cement.psc.ssl'].browse(self.ids[0])
        field_values = {}
...
class CementTestPsc(models.Model):
    _name = "mechanical.cement.psc.test1"
    _rec_name = "name"
    name = fields.Char("Name")


class SoundnessCementLinePsc(models.Model):
    _name= "cement.psc.soundness.ssl.line"

    parent_id = fields.Many2one('mechanical.cement.psc.ssl')
...
class DrySievingLinePsc(models.Model):
    _name = "cement.psc.dry.sieving.ssl.line"
...
class Casting3DaysLinePsc(models.Model):
    _name = "cement.psc.casting.3days.ssl.line"

    parent_id = fields.Many2one('mechanical.cement.psc.ssl',string="Parent Id")
...
class Casting7DaysLinePsc(models.Model):
    _name = "cement.psc.casting.7days.ssl.line"
...
class Casting28DaysLinePsc(models.Model):
    _name = "cement.psc.casting.28days.ssl.line"
