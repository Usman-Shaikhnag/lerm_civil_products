...
class SolidConcreteBlockDatasheet(models.AbstractModel):
    _name = 'report.solid_concrete_block.solid_block_datasheet'
    _description = 'Solid Block Datasheet'
...
class SolidConcreteReport(models.AbstractModel):
    _name = 'report.solid_concrete_block.solid_concrete_report'
    _description = 'Solid Concrete Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/solid_concrete/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
