...
class SteelTmtBar(models.AbstractModel):
    _name = 'report.tmt_bar.steel_tmt_bar_report1'
    _description = 'Steel TMT Bar Report 1'
...
class SteelTmtBarDataSheet(models.AbstractModel):
    _name = 'report.tmt_bar.steel_tmt_bar_datasheet1'
    _description = 'Steel TMT Bar DataSheet 1'
