...
class WOOD(models.Model):
    ...
    def get_all_fields(self):
        record = self.env['mechanical.wood.ssl'].browse(self.ids[0])
        field_values = {}
...
class MechanicalMoistureLine(models.Model):
    _name = "mechanical.moisture.ssl.line"
    parent_id = fields.Many2one('mechanical.wood.ssl',string="Parent Id")
...
class MechanicalSpecificLine(models.Model):
    _name = "mechanical.specific.gravity.ssl.line"
    parent_id = fields.Many2one('mechanical.wood.ssl',string="Parent Id")
