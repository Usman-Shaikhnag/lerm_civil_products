...
class CementPPC(models.Model):
    ...
    fneness_cement_lines = fields.One2many('fineness.cement.ppc.ssl.line','parent_id',string="Fineness Cement")
    ...
    density_cement_lines = fields.One2many('density.cement.ppc.ssl.line','parent_id',string="Fineness density")
    ...
    fineness_blaine_lines = fields.One2many('fineness.blaine.ppc.ssl.line','parent_id',string="Fineness blaine")
    ...
    soundness_cement_lines = fields.One2many('soundness.cement.ppc.ssl.line','parent_id',string="Soundness")
    ...
    consistency_cement_lines = fields.One2many('consistensy.cement.ppc.ssl.line','parent_id',string="Consistency")
    ...
    setting_time_lines = fields.One2many('setting.time.ppc.ssl.line','parent_id',string="Setting time",default=lambda self: self._default_setting_time_lines())
    ...
    def _compute_initial_setting_time_conformity(self):
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','101245687tyy-372f-4775-9bcb-e9dd723547htui')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','101245687tyy-372f-4775-9bcb-e9dd723547htui')]).parameter_table
            mu_value = line.mu_value
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
    ...
    def _compute_final_setting_time_conformity(self):
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','201332ttyy77-372f-4775-9bcb-e9dd723547htui')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','201332ttyy77-372f-4775-9bcb-e9dd723547htui')]).parameter_table
            mu_value = line.mu_value
            for material in materials:
                if material.grade.id == record.grade.id:
                    req_min = material.req_min
    ...
    compressive_lines = fields.One2many('compressive.ppc.ssl.line','parent_id',string="Compressive")
    ...
    def _compute_visible(self):
        for record in self:
            ...
            for sample in record.sample_parameters:
                ...
                if sample.internal_id == '2014456-372f-4775-9bcb-e9dd70e3587g':
    ...
    # import wdb; wdb.set_trace()
        for result in self.eln_ref.parameters_result:
            ...
            if result.parameter.internal_id == '101245687tyy-372f-4775-9bcb-e9dd723547htui':
                ...
                if self.initial_setting_time_nabl == 'pass':
                    ...
                    result.nabl_status = 'non-nabl'
                continue
            if result.parameter.internal_id == '201332ttyy77-372f-4775-9bcb-e9dd723547htui':
    ...
    def get_all_fields(self):
        record = self.env['cement.ppc.ssl'].browse(self.ids[0])
        field_values = {}
...
class FinenessCementLine(models.Model):
    _name = "fineness.cement.ppc.ssl.line"
    parent_id = fields.Many2one('cement.ppc.ssl',string="Parent Id")
...
class DensityCementLine(models.Model):
    _name = "density.cement.ppc.ssl.line"
    parent_id = fields.Many2one('cement.ppc.ssl',string="Parent Id")
...
class FinenessBlaineLine(models.Model):
    _name = "fineness.blaine.ppc.ssl.line"
    parent_id = fields.Many2one('cement.ppc.ssl',string="Parent Id")
...
class soundnessCementLine(models.Model):
    _name = "soundness.cement.ppc.ssl.line"
    parent_id = fields.Many2one('cement.ppc.ssl',string="Parent Id")
...
class ConsistencyCementLine(models.Model):
    _name = "consistensy.cement.ppc.ssl.line"
    parent_id = fields.Many2one('cement.ppc.ssl',string="Parent Id")
...
class CompressiveCementLine(models.Model):
    _name = "compressive.ppc.ssl.line"
    parent_id = fields.Many2one('cement.ppc.ssl',string="Parent Id")
