...
class CementPpc(models.Model):
    _name = "mechanical.cement.ppc1"
    _inherit = "lerm.eln"
    _description = 'mechanical.cement.ppc1'
    _rec_name = "name"
    ...
    soundness_table = fields.One2many('cement.ppc.soundness.line1','parent_id',string="Soundness")
    ...
    dry_sieving_table = fields.One2many('cement.ppc.dry.sieving.line1','parent_id',string="Dry Sieving")
    ...
    casting_3_days_tables = fields.One2many('cement.ppc.casting.3days.line1','parent_id',string="3 Days")
    ...
    casting_7_days_tables = fields.One2many('cement.ppc.casting.7days.line1','parent_id',string="7 Days")
    ...
    casting_28_days_tables = fields.One2many('cement.ppc.casting.28days.line1','parent_id',string="28 Days")
    ...
    def get_all_fields(self):
        record = self.env['mechanical.cement.ppc1'].browse(self.ids[0])
        field_values = {}
...
class SoundnessCementLinePpc(models.Model):
    _name= "cement.ppc.soundness.line1"

    parent_id = fields.Many2one('mechanical.cement.ppc1')
...
class DrySievingLinePpc(models.Model):
    _name = "cement.ppc.dry.sieving.line1"
...
class Casting3DaysLinePpc(models.Model):
    _name = "cement.ppc.casting.3days.line1"

    parent_id = fields.Many2one('mechanical.cement.ppc1',string="Parent Id")
...
class Casting7DaysLinePpc(models.Model):
    _name = "cement.ppc.casting.7days.line1"
...
class Casting28DaysLinePpc(models.Model):
    _name = "cement.ppc.casting.28days.line1"
