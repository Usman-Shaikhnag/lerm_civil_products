...
class AacBlockReport1(models.AbstractModel):
    _name = 'report.aac_block.aac_block_mech_report1'
    _description = 'AAC Block Report 1'
...
class AacDatasheet(models.AbstractModel):
    _name = 'report.aac_block.aac_block_datasheet1'
    _description = 'AAC Block DataSheet 1'
