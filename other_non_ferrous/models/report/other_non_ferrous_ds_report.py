...
class OtherNonFerrousDatasheet1(models.AbstractModel):
    _name = 'report.other_non_ferrous.other_non_ferrous_datasheet'
    _description = 'Other non ferrous DataSheet'
...
class OtherNonFerrousReport(models.AbstractModel):
    _name = 'report.other_non_ferrous.other_non_ferrous_report'
    _description = 'Other Non Ferrous Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/brickclay/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
