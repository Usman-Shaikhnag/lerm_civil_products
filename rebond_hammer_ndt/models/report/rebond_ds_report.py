...
class RebondHammerReport(models.AbstractModel):
    _name = 'report.rebond_hammer_ndt.rebond_hammer_ndt_report'
...
class RebondHammerDataSheet(models.AbstractModel):
    _name = 'report.rebond_hammer_ndt.rebond_hammer_ndt_datasheet'
