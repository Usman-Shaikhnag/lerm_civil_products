...
class DryingShrinkageReport(models.AbstractModel):
    _name = 'report.drying_shrinkage.drying_shrinkage_repprt1'
    _description = 'Drying Shrinkage Report 1'
...
class DryingShrinkageDatasheet(models.AbstractModel):
    _name = 'report.drying_shrinkage.drying_shrinkage_datasheet1'
    _description = 'Drying Shrinkage DataSheet 1'
