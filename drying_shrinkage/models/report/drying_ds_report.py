...
# class DryingShrinkageReport(models.AbstractModel):
#     _name = 'report.drying_shrinkage.drying_shrinkage_repprt'
#     _description = 'Drying Shrinkage Report'
...
#         drying_data = self.env[model].search([("id","=",eln.model_id)])
#         return {
#             'eln': eln,
#             'drying': drying_data,
#             'qrcode': qr_code,
...
class DryingShrinkageReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/drying/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
...
class DryingShrinkageDatasheet(models.AbstractModel):
    _name = 'report.drying_shrinkage.drying_shrinkage_datasheet'
    _description = 'Drying Shrinkage DataSheet'
