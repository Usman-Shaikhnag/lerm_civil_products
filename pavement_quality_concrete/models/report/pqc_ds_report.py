...
class PavementQualityConcreteReport(models.AbstractModel):
    _name = 'report.pavement_quality_concrete.pqc_report'
    _description = 'Pavement Quality Concrete Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/pqc/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
...
class PavementQualityConcreteDataSheet(models.AbstractModel):
    _name = 'report.pavement_quality_concrete.pqc_datasheet'
    _description = 'Pavement Quality Concrete DataSheet'
