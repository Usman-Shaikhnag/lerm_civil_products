...
class BitumenConcreteDatasheet(models.AbstractModel):
        _name = 'report.bitumen_concrete.bitumen_concrete_datasheet_ssl'
...
#     _name = 'report.bitumen_concrete.bitumen_concrete_report_ssl'
...
class BitumenConcreteReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        base_url = self.env["ir.config_parameter"].sudo().get_param("web.base.url")
        report_url = f"{base_url}/download_report/bitumen_concrete/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
