...
class CoarseAggregateReport2(models.AbstractModel):
    _name = 'report.coarse_aggregate2.lerm_coarse_aggregate_mech_report2'
...
class CoarseAggregateDataSheet2(models.AbstractModel):
    _name = 'report.coarse_aggregate2.coarse_aggregate_datasheet2'
