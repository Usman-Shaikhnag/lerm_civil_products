...
class NaturalStoneDatasheet(models.AbstractModel):
        _name = 'report.natural_bulding_stone.natural_stone_datasheet'
        _description = 'Natural Stone DataSheet'
...
class NaturalBuildingStonereport(models.AbstractModel):
    _name = 'report.natural_bulding_stone.natural_building_stone_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/naturalstone/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
