...
class FerrousInclusionDatasheet(models.AbstractModel):
    _name = 'report.ferrous_inclusion.ferrous_inclusion_datasheet'
    _description = 'Ferrous Inclusion Datasheet'
...
class FerrousInclusionReport(models.AbstractModel):
    _name = 'report.ferrous_inclusion.ferrous_inclusion_report'
    _description = 'Ferrous Inclusion Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/inclusion/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
