...
class BituminiousReport(models.AbstractModel):
    _name = 'report.bituminous_macadam.bituminous_macadam_report'
    _description = 'Bituminous Macadam Report'
...
class BituminousDataSheet(models.AbstractModel):
    _name = 'report.bituminous_macadam.bituminous_macadam_datasheet'
    _description = 'Bituminous Macadam DataSheet'
    ...
    def _get_report_values(self, docids, data):
        ...
        model_name = eln.material.product_based_calculation.ir_model.model
