...
class BituminousMacadam(models.Model):
    ...
    name_bitumen = fields.Char("Name",default="Bituminous Macadam")
    ...
    def _compute_binder_content_conformity(self):
        ...
        for record in self:
            ...
            line = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','124587963-7188-4086-b132-62b50e63f1247ui')])
            materials = self.env['lerm.parameter.master'].sudo().search([('internal_id','=','124587963-7188-4086-b132-62b50e63f1247ui')]).parameter_table
    ...
    sieve_analysis_child_lines = fields.One2many('bituminous.macadam.combined.gradation.line','parent_id',string="Parameter")
        ...
        for rec in self:
            ...
            if grade_name == "Bituminous Macadam":
                sieve_sizes = ['45 mm', '37.5 mm', '26.5 mm', '19 mm', '13.2 mm',
                            '4.75 mm', '2.36 mm', '300 μm', '75 μm', 'Pan']
        ...
        for record in self:
            ...
            for line in record.sieve_analysis_child_lines:
                ...
                if previous_line == 0:
                    ...
                    previous_line_record = self.env['bituminous.macadam.combined.gradation.line'].sudo().search([
    ...
    def _compute_visible(self):
        ...
        for record in self:
            ...
            for sample in record.sample_parameters:
                ...
                if sample.internal_id == "23457896214-7188-4086-b132-62b50e63f1247ui":
                    record.sieve_visible = True

                if sample.internal_id == "124587963-7188-4086-b132-62b50e63f1247ui":
    ...
    # import wdb; wdb.set_trace()
        for result in self.eln_ref.parameters_result:
            if result.parameter.internal_id == '124587963-7188-4086-b132-62b50e63f1247ui':
    ...
    def get_all_fields(self):
        record = self.env['bituminous.macadam'].browse(self.ids[0])
        field_values = {}
