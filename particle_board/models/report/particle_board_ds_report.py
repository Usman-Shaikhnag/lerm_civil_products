...
class ParticleBoardDatasheet(models.AbstractModel):
        _name = 'report.particle_board.particle_board_datasheet'
...
class ParticleBoardReport(models.AbstractModel):
    _name = 'report.particle_board.particle_board_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/particleb/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
