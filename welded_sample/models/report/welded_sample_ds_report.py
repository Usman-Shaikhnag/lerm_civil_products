...
class WeldedSampleDatasheet1(models.AbstractModel):
    _name = 'report.welded_sample.welded_sample_datasheet'
...
class WeldedSampleReport(models.AbstractModel):
    _name = 'report.welded_sample.welded_sample_report'
