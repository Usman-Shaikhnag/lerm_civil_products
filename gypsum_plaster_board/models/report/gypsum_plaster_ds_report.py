...
class GypsumPlasterDatasheet(models.AbstractModel):
...
class GypsumPlasterReport1(models.AbstractModel):
    _name = 'report.gypsum_plaster_board.gypsum_plaster_board_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        report_url = f"{base_url}/download_report/gypsump/{'nabl' if nabl else 'nonnabl'}/{eln.id}"
